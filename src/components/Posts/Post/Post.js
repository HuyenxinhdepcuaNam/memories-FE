...
import { deletePost, getCurrentId, getPosts, likePost } from '../../../features/posts/postSlice';
            ...
            <CardHeader
                avatar={
                    <Avatar sx={{ bgcolor: red[500] }} aria-label="recipe">
                        {post.creator ? post.creator.substring(0, 1).toUpperCase() : 'Z'}
                    </Avatar>
                }
                action={
                    <IconButton aria-label="settings"
                        onClick={() => dispatch(getCurrentId(post._id))}>
                        <MoreVertIcon />
                    </IconButton>
                }
                title={post.title}
